<head>
    ...
    <meta name="description" content="Learn about cutting-edge agro solutions at SV Agro. With the help of our research-based insights and products, maximize the potential of your crops. ">
    <meta name="keywords" http-equiv="fertlizers manufacturers in pune,agriculture fertlizers suppliers in pune,agriculture pesticides suppliers in pune,Agri solution providers in pune, agri business in pune, agriculture services in pune, agriculture service providers in pune, agri consultants in pune, agri consultancy in pune,agri business in pune, agri culture business in pune" />

    <link rel="canonical" href="https://svagrosolutions.com/home/publications" />

    <link rel="alternate" hreflang="en-IN" href="https://svagrosolutions.com/home/publications" />
    ...
    <meta property="og:url" content="https://svagrosolutions.com/home/publications">
    ...
    <meta name=”twitter:site” content=”https://svagrosolutions.com/home/publications" />
    ...
    <!-- ========== Page Title ========== -->
    <title>Publications : Micronutrient Fertilizer Company</title>
...
<section class="page-header bg_img padding-tb1">
    ...
    <div class="container">
        <div class="page-header-content-area">
            <h4 class="ph-title">publications</h4>
            <ul class="agri-ul">
                ...
                <div class="col-lg-12 col-12">
                    <article>
                        <div class="shop-product-wrap grids row justify-content-center">
                            <?php foreach ($publication as $value) { ?>
                                    ...
                                    <div class="product-item">
                                        ...
                                        <img src="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>" alt="shope"/>
                                            ...
                                            <div class="product-action-link">
                                                <a href="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>" data-lightbox="models" data-rel="lightcase" data-title="Caption1"><i class="icofont-eye"></i></a>
                                            </div>
                                        </div>
