<head>
    ...
    <meta name="description" content="We are a top provider of CRF fertilizers and micronutrients. Improve farming with our premium products that are created to maximize crop yields and soil health.">
    <meta name="keywords" http-equiv="pesticides providers in puneI SV agro solutions pvt ltd, agri organic products manufacturers in pune, organic pesticides in pune, agricultural pesticides in pune, agricultural fertlizers in pune, agriculture pesticides manufacturers in pune, agriculture fertlizers manufacturers in pune,agriculture fertlizers suppliers in pune,agriculture pesticides suppliers in pune" />

    <link rel="canonical" href="https://svagrosolutions.com/home/award_and_recognitions" />

    <link rel="alternate" hreflang="en-IN" href="https://svagrosolutions.com/home/award_and_recognitions" />
    ...
    <meta property="og:url" content="https://svagrosolutions.com/home/award_and_recognitions">
    ...
    <meta name=”twitter:site” content="https://svagrosolutions.com/home/award_and_recognitionss" />
    ...
    <!-- ========== Page Title ========== -->
    <title>Natural Biostimulants | SV Agro Solutions</title>
...
<section class="page-header bg_img padding-tb1">
    ...
    <div class="container">
        <div class="page-header-content-area">
            <h4 class="ph-title">Awards & Recognitions</h4>
            <ul class="agri-ul">
                <li><a href="<?php echo base_url() . 'home'; ?>">Home</a></li>
                <li><a class="active">Awards & Recognitions</a></li>
            </ul>
        </div>
    </div>
</section>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="product-item">
                                        <div class="product-thumb">
                                            <!-- <a href="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>"data-lightbox="models" data-title="Caption1">
                                        <img src="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>" alt="shope"/>
                                             </a> -->
                                            <img src="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>" alt="shope">
                                            <div class="product-action-link">
                                                <a href="<?php echo base_url() . 'SV_agroAdmin/' . $value['image']; ?>" data-rel="lightcase" data-lightbox="models" data-title="Caption1"><i class="icofont-eye"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h4><a href="#" style="color: #3CB815;">
