        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                <div class="primary-menu">
                    <div class="logo">
                        <a href="<?php echo base_url() . 'home'; ?>"><img src="<?php echo base_url() . 'assets/images/logo/SV-Ecocert-New.png'; ?>" alt="SV Agro Solutions" title="SV Agro Solutions" style="width: 181px;"></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="main-area">
                            <div class="main-menu">
                                <ul class="agri-ul">
                                <li class="<?php if ($controller == 'Home' && $method == 'index') {
                                                    echo 'active';
                                                } ?>">
                                    ...
                                    <li>
                                        <a <?php if (
                                                $controller == "Home" && $method == "about_us" ||
                                                $controller == "Home" && $method == "certificate" ||
                                                $controller == "Home" && $method == "our_Inspiration" ||
                                                $controller == "Home" && $method == "Management"
                                            ) {
                                                echo "active";
                                            } else {
                                                echo "";
                                        ...
                                        <ul class="agri-ul">
                                            ...
                                            <li><a href="<?php echo base_url() . 'our_Inspiration'; ?>">Our Inspiration </a></li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="agri-ul">
                                            ...
                                            foreach ($cat as $ccc) {
                                            ?>
                                                <li><a href="<?php echo base_url() . 'home/products/' . $ccc['category_id']; ?>"><?php echo $ccc['name']; ?></a></li>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <li>
                                        ...
                                        <ul class="agri-ul">
                                            <li><a href="<?php echo base_url() . 'upcoming_events'; ?>">Upcoming Events</a></li>
                                            <li><a href="<?php echo base_url() . 'award_and_recognitions'; ?>">Awards & Recognitions </a></li>
