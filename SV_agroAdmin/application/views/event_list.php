                      ...
                      ?>
                        <tr>
                          ...
                          <td> <?php $status = $row['status'];
                                if ($status == 'Active') { ?>
                              <a href="<?php echo base_url() . 'AdminData/event_status/' . $id; ?>" class="btn btn-success btn-sm"><?php echo $status; ?></a>
                            <?php } else { ?>
                              <a href="<?php echo base_url() . 'AdminData/event_status/' . $id; ?>" class="btn btn-danger btn-sm"><?php echo $status; ?></a>
                            <?php } ?>
                          </td>
                      ...
                      <div class="modal-dialog  modal-md">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="<?php echo base_url() . 'AdminData/update_event'; ?>" class="form" id="form" name="form" enctype="multipart/form-data">
                              ...
                              <textarea class="ckeditor" name="description" id="editor" placeholder="Enter description" required><?php echo $row['description']; ?></textarea>
    ...
    <div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog  modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?php echo base_url() . 'AdminData/add_event'; ?>" enctype="multipart/form-data" class="form" id="form">

              <div class="form-group">
                <label for="exampleSelectRounded0">NAME</label>
                <input type="text" class="form-control" id="name" name="name" value="" placeholder="Enter event name" required>
              </div>
