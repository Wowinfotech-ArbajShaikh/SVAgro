          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <center>
                  <h3 class="card-title"><b>Contact Enquiry List</b></h3>
                  <center>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php
                            ...
                            echo date("d-m-Y", strtotime($row['date'])); // format the timestamp as a string in the desired format
                            ?></td>
                        <td> <?php $status = $row['status'];
                                if ($status == 'Completed') { ?>
                              <a href="<?php echo base_url() . 'AdminData/contact_status/' . $id; ?>" class="text-success btn-sm"><?php echo $status; ?></a>
                            <?php } else { ?>
                              <a href="<?php echo base_url() . 'AdminData/contact_status/' . $id; ?>" class="text-danger btn-sm"><?php echo $status; ?></a>
                            <?php } ?>
                          </td>
                          <td>
                          ...
                          <a href="<?php echo base_url().'AdminData/delete_contact_enquiry/'.$id?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o"></i></a></td>
