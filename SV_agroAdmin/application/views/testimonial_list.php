          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <center>
                  <h3 class="card-title"><b>Testimonial List</b></h3>
                  <center>
                      ...
                      ?>
                        <tr>
                          ...
                          <td> <?php $status = $row['status'];
                                if ($status == 'Active') { ?>
                              <a href="<?php echo base_url() . 'AdminData/testimonial_status/' . $id; ?>" class="btn btn-success btn-sm"><?php echo $status; ?></a>
                            <?php } else { ?>
                              <a href="<?php echo base_url() . 'AdminData/testimonial_status/' . $id; ?>" class="btn btn-danger btn-sm"><?php echo $status; ?></a>
                            <?php } ?>
                          </td>
                      ...
                      <div class="modal-dialog  modal-md">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="POST" action="<?php echo base_url() . 'AdminData/update_testimonial'; ?>" class="form" id="form" name="form" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label>Title</label>
                                <input type="text" class="form-control" id="title" name="title" value="<?php echo $row['title']; ?>" placeholder="Enter tilte" required>
                              </div>
                              <div class="form-group">
                                <label>Video url</label>
                                <input type="text" class="form-control" id="video_url" name="video_url" value="<?php echo $row['video_url']; ?>" placeholder="Enter video url" required>
                              </div>
                              <div class="form-group">
                              ...
                              <textarea class="ckeditor" name="description" id="editor" required> <?php echo $row['description']; ?></textarea>
    ...
    <div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog  modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?php echo base_url() . 'AdminData/add_testimonial'; ?>" class="form" id="form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Video url</label>
                <input type="text" class="form-control" id="video_url" name="video_url" value="" placeholder="Enter video url" required>
              </div>
              <div class="form-group">
                <label>IMAGE</label>
                <br>
              ...
              <textarea class="ckeditor" name="description" id="editor" placeholder="Enter description" required></textarea>
          </div>
